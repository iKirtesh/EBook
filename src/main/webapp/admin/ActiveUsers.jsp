...
<%@ page import="com.mysql.cj.NativeQueryAttributesBindings" %>
...
<table class="table mt-5">
    ...
    <tr>
        ...
        <td>
<%--            <a href="${pageContext.request.contextPath}/adminDisables?id=<%= user.getId() %>"--%>
<%--               class="link-warning"--%>
<%--               onclick="return confirm('Are you sure you want to disable this user?');">Disable</a>--%>

    <a href="${pageContext.request.contextPath}/adminDisables?id=<%= user.getId() %>"
       class="link-warning"
      onclick="showToast();">Disable</a>
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            ...
            <strong class="me-auto">Sucessfully Disabled</strong>
